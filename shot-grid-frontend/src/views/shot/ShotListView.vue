...
<template><section class="page domain-page"><header class="page-heading"><div><span class="eyebrow">SHOTS</span><h1>镜头管理</h1><p class="lead">三种视图共享同一份服务端查询结果和统计口径。</p></div><el-segmented v-model="view" :options="[{ label: '表格', value: 'table' }, { label: '卡片', value: 'cards' }, { label: '故事板', value: 'storyboard' }]" /></header>
