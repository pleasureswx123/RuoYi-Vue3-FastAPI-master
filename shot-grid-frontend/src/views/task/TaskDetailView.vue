...
import { getTaskVersion, getVersionSubmission, initializeVersionSubmission, listTaskVersions, retryVersionSubmission, uploadProtectedVersionFile, versionFileUrl } from '@/api/shot-grid/versions'
...
async function load() {
  const [taskData, versionData] = await Promise.all([
