...
export const stableRoutes = [
  ...
  { path: '/service-error', name: 'ServiceError', component: () => import('@/views/error/ServiceErrorView.vue'), meta: { public: true } },
  {
    path: '/', component: AppLayout, redirect: '/workbench', children: [
      ...
      { path: 'projects', name: 'Projects', component: () => import('@/views/project/ProjectListView.vue'), meta: { navigationKey: 'projects' } },
      ...
      { path: 'projects/:projectId/members', name: 'ProjectMembers', component: () => import('@/views/project/ProjectSectionView.vue'), props: true, meta: { navigationKey: 'projects', section: '成员' } },
